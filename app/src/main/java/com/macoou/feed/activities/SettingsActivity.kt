...
import com.macoou.feed.activities.SettingsActivity.PreferenceKeys.CACHE_EXPIRATION
import com.macoou.feed.activities.SettingsActivity.PreferenceKeys.MATERIAL_YOU
import com.macoou.feed.activities.SettingsActivity.PreferenceKeys.SETTINGS
import com.macoou.feed.activities.SettingsActivity.PreferenceKeys.THEME
import com.macoou.feed.activities.ui.theme.feedbrTheme
import com.macoou.feed.activities.ui.theme.paddingLarge
import com.macoou.feed.dataclasses.Feed
import com.macoou.feed.dataclasses.FeedGroup
import com.macoou.feed.operations.ClearData
import com.macoou.feed.room.DatabaseGateway
import com.macoou.feed.ui.*
import com.macoou.feed.operations.ExportData
import com.macoou.feed.operations.ImportData
import com.macoou.feed.operations.ViewModel
import kotlin.properties.Delegates
import com.macoou.feed.ui.PreferenceTitle as PreferenceTitle
...
class SettingsActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            feedbrTheme(theme = themeState.value, materialYou = materialYouState.value) {
                UI()
            }
        }
     ...
     *
     * The database files can be found in `Android/data/data/com.macoou.feed.databases`.
     *
            ...
            Surface(color = MaterialTheme.colorScheme.background) {
                Scaffold(topBar = { TopBar("Settings") { finish() } }) {
                    ...
                    Column(
                        ...
                        PreferenceTitle(title = "Licenses")
